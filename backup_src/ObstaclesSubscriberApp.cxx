...
/*!
 * @file ObstaclesSubscriberApp.cxx
 * This file contains the implementation of the subscriber functions.
 *
 * This file was generated by the tool fastddsgen.
 */

#include "ObstaclesSubscriberApp.hpp"
...
ObstaclesSubscriberApp::ObstaclesSubscriberApp(
        const int& domain_id)
    : factory_(nullptr)
    ...
    , stop_(false)
{
    ...
    {
        throw std::runtime_error("Obstacles Subscriber initialization failed");
    }
    ...
    if (reader_ == nullptr)
    {
        throw std::runtime_error("Obstacles DataReader initialization failed");
    }
}
...
void ObstaclesSubscriberApp::on_subscription_matched(
        DataReader* /*reader*/,
...
void ObstaclesSubscriberApp::on_data_available(
        DataReader* reader)
{
    Obstacles sample_;
    SampleInfo info;
...
void ObstaclesSubscriberApp::run()
{
...
bool ObstaclesSubscriberApp::is_stopped()
{
    return stop_.load();
}

void ObstaclesSubscriberApp::stop()
{
    stop_.store(true);
