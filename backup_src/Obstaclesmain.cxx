        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<ObstaclesApplication> app;
    ...
    else
    {
        try
        {
            app = ObstaclesApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&ObstaclesApplication::run, app);
