...
Obstacles::Obstacles()
{
    // m_obstacles_x com.eprosima.idl.parser.typecode.SequenceTypeCode@376b4233

    // m_obstacles_y com.eprosima.idl.parser.typecode.SequenceTypeCode@2fd66ad3

    // m_obstacles_number com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5d11346a
...
size_t Obstacles::getMaxCdrSerializedSize(
...
size_t Obstacles::getCdrSerializedSize(
 ...
 */
const std::vector<int32_t>& Obstacles::obstacles_x() const
{
 ...
 */
std::vector<int32_t>& Obstacles::obstacles_x()
{
    return m_obstacles_x;
}
/*!
 ...
 */
const std::vector<int32_t>& Obstacles::obstacles_y() const
{
 ...
 */
std::vector<int32_t>& Obstacles::obstacles_y()
{
    return m_obstacles_y;
}
/*!
 ...
 */
void Obstacles::obstacles_number(
 ...
 */
int32_t Obstacles::obstacles_number() const
{
 ...
 */
int32_t& Obstacles::obstacles_number()
{
    return m_obstacles_number;
}


size_t Obstacles::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
bool Obstacles::isKeyDefined()
{
    return false;
}

void Obstacles::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
